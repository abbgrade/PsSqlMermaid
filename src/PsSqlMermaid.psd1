#
# Module manifest for module 'PsSqlMermaid'
#
...
@{
    ...
    GUID                 = '33d08de2-cec3-49b9-92e6-14135e59663a'
    ...
    Description          = 'Module to generate mermaid ER diagrams for SQL Server databases.'
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'https://github.com/abbgrade/PsSqlMermaid/blob/feature/PsMermaidTools/CHANGELOG.md'
    ...
    DefaultCommandPrefix = 'SqlMermaid'
